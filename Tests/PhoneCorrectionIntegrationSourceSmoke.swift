...
struct PhoneCorrectionIntegrationSourceSmoke {
    static func main() throws {
        ...
        precondition(content.contains("分享 P 点标准答案"))
        precondition(content.contains("PPointGroundTruthExportService.export("))
        ...
        precondition(workspace.contains("private func requestAnalysis()"))
        precondition(workspace.contains("showsResultsSheet = true"))
        precondition(workspace.contains("选择后将使用对应视角分析视频"))
